...
export function ProductHero() {
  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-32 pb-16 text-white">
      {/* Background Gradient - Premium Dark Blend */}
      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="space-y-6 lg:space-y-8 lg:sticky lg:top-32">
          {/* Header Block */}
          <div>
            <p className="text-xs tracking-[0.3em] uppercase text-zinc-400 mb-4">Essential Fatty Acids</p>
            <h1 className="font-serif text-5xl md:text-6xl mb-6">Omega-3 Elite</h1>
            <p className="text-xl text-zinc-200 leading-relaxed">
              Triple-strength fish oil with 2,000mg EPA/DHA per serving. Molecularly distilled for purity, third-party
          ...
          <div className="flex items-baseline gap-4">
            <span className="text-5xl font-serif text-white">${48}</span>
            <span className="text-zinc-400 text-lg">/ 60 softgels</span>
          </div>

          {/* Quantity & Cart Block */}
          <div className="space-y-4">
            <div className="flex items-center gap-6">
              <label className="text-sm tracking-widest uppercase text-zinc-300 whitespace-nowrap">Quantity</label>
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  // Refined Style: Dark background, light text, subtle hover
                ...
                {/* Quantity Display - Bold and Clear */}
            ...
            {/* Add to Cart Button - High Contrast for CTA */}
            <Button 
                // Changed to black background with white text for a high-contrast CTA on the dark theme
          ...
          <div className="pt-8 border-t border-zinc-700 space-y-4 text-sm">
            <div className="flex justify-between">
              <span className="text-zinc-400">Third-Party Tested</span>
              <span className="text-white font-medium">✓ NSF Certified</span>
            </div>
            <div className="flex justify-between">
              <span className="text-zinc-400">Bioavailability</span>
